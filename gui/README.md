...
Use the **Record** button while connected to write incoming ADC samples to CSV. Each recording is saved as `Recordings/teng_recording_YYYYMMDD_HHMMSS.csv` from the repository root and includes sample index plus calibrated CH0-CH3 values in mV.
